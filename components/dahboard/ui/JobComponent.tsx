...
function JobComponent({job}: {job: Job}) {
  return (
    <div key={job.job_id} className='border border-gray-200 rounded-xl p-6 hover:shadow-md transition-all duration-200 hover:border-green-300'>
                      ...
                      <div className='flex items-start justify-between gap-4'>
                        <div className='flex-1'>
                          <h4 className='font-semibold text-lg text-gray-800 hover:text-green-600 cursor-pointer mb-1'>
                            <a href={job.job_url} target='_blank' rel='noopener noreferrer' className='hover:underline'>
                              {job.job_title}
                            </a>
                          </h4>
